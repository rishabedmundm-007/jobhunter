    ...
    >
      ...
      >
        <div className="mb-5 flex items-center justify-between">
          <h2 className="font-display text-2xl font-extrabold text-ink dark:text-white">My Resume</h2>
          <button
            onClick={onClose}
            aria-label="Close"
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-slate-200 p-4 dark:border-slate-700">
            <div className="font-semibold text-slate-800 dark:text-slate-100">{resume.filename}</div>
        ...
        >
          ...
          <div className="mt-1 text-xs text-slate-500 dark:text-slate-400">
            Drag &amp; drop or click to browse · PDF or Word, up to 10MB
          </div>
        </div>
